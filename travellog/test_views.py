...
class TestViews(TestCase):
    ...
    #     """Test if update_logentry page renters correctly """
    #     response = self.client.get('/update_logentry/')
    #     self.assertEqual(response.status_code, 200)
    #     self.assertTemplateUsed(response, 'update_logentry.html')

    # def test_logentry_detail(self):
    #     """Tests if logentry_detail page renders correctly """
    #     response = self.client.get('/logentry_detail/')
    #     self.assertEqual(response.status_code, 200)
    #     self.assertTemplateUsed(response, 'logentry_detail.html')
